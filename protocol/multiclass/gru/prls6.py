...
model = Sequential()
model.add(GRU(64,input_dim=22, return_sequences=True))  # try using a GRU instead, for fun
...
model.add(GRU(64, return_sequences=True))  # try using a GRU instead, for fun
model.add(Dropout(0.1))
model.add(GRU(64,input_dim=41, return_sequences=False))  # try using a GRU instead, for fun
model.add(Dropout(0.1))
model.add(Dense(11))
