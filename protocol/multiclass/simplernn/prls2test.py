...
model = Sequential()
model.add(SimpleRNN(8,input_dim=23, return_sequences=True))  # try using a GRU instead, for fun
...
y_test = y_train
# try using different optimizers and different optimizer configs
model.load_weights("kddresults/lstm2layer/checkpoint-997.hdf5")
#y_train1 = y_test
#model.compile(loss='binary_crossentropy',optimizer='adam',metrics=['accuracy'])

y_pred = model.predict_classes(X_test)
np.savetxt('res/expected2.txt', y_test1, fmt='%01d')
