...
#np.savetxt('deep/LRpredicted.txt',predicted[:,1])
...
#np.savetxt('deep/NBpredicted.txt',predicted[:,1])
...
#np.savetxt('deep/KNNpredicted.txt',predicted[:,1])
...
predicted = model.predict(testdata)
# summarize the fit of the model
#np.savetxt('deep/DTpredicted.txt',predicted[:,1])
...
predicted = model.predict(testdata)
# summarize the fit of the model
#np.savetxt('deep/ABpredicted.txt',predicted[:,1])
...
predicted = model.predict(testdata)
# summarize the fit of the model
#np.savetxt('deep/RFpredicted.txt',predicted[:,1])
print("--------------------------------------RF--------------------------------------")
